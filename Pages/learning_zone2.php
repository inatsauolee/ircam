        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10">
                <div class="col-md-auto">
                    ...
                    <div><br />
                        <h3> Où est la photo correspondant à <?php //echo 
                                                                ?> </h3>
                        <!-- check box -->
                        <table class="table table-striped table-bordered" class="form-inline">
                            <tr>
                                <td align=center>
                                    <div class="checkbox">
                                        <label><img class=img-responsive src="../img/mg-sys.png" width="100px" height="200px"></br><input type="checkbox" value="">&nbsp;&nbsp;Option 1</label>
                                    </div>
                                </td>
                                <td align=center>
                                    <div class="checkbox">
                                        <label><img class=img-responsive src="../img/mg-sys.png" width="100px" height="200px"></br><input type="checkbox" value="">&nbsp;&nbsp;Option 2</label>
                                    </div>
                                </td>
                                <td align=center>
                                    <div class="checkbox disabled">
                                        <label><img class=img-responsive src="../img/mg-sys.png" width="100px" height="200px"></br><input type="checkbox" value="">&nbsp;&nbsp;Option 3</label>
                                    </div>
                                </td>
                        </table>
                    </div>
