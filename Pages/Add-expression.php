      ...
      <div class="col-md-10">
        <div class="col-md-auto">
          ...
          <div class="form-group">
            <label for="cin">L'expression en anglais :</label>
            <input type="text" name="cin" placeholder="Veuillez de saisir L'expression en anglais" class="form-control" />
          </div>
          <!-- L'expression en Tifinagh -->
          <div class="form-group">
            <label for="cin">L'expression en Tifinagh :</label>
