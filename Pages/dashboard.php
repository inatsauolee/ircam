...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- la deuxieme colonne -->
      <div class="col-md-8">
        <h3>Learning methodology</h3><br />
        <!-- --------------------------------- ---------------------------------- -->
        <!-- --------------------------------- ---------------------------------- -->
        <div class="container">
          <?php foreach ($resultatEt as $collection) { ?>
            <div class="panel-group">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <a href="collection.php?id=<?php echo $collection['ID'] ?>" class="btn btn-info btn-lg btn-block" role="button">
                    <span class="fa fa-save"></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $collection['label'] ?></a>
                </div>
